                ...
                user_exists.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            session.setSharedPreference(user.getName(), user.getPhone(), user.getBlood(), user.getAddress(), user.getGender(), user.getAge(), user.getDiseases(), user.getImgurl(), user.getEmail(), user.getPin(),user.getPanic());
