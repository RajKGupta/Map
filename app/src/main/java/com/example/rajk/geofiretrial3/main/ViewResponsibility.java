...
public class ViewResponsibility extends AppCompatActivity implements gaundian_adapter.phonebook_adapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_responsibility);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot ds : dataSnapshot.getChildren()) {
                        ...
                        gaurdians_and_responsibilities gar = new gaurdians_and_responsibilities(ds.getKey(), "", "", installed, "");
